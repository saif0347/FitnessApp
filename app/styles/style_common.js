...
export const getCircleFill = (size,color)=>{
  return {backgroundColor:color,alignItems:'center',justifyContent:'center',width:size,height:size,borderRadius:size/2};
};
...
export const stylesC = StyleSheet.create({
  ...
  // container
  main:{flex:1,paddingHorizontal:mainSidePadding,paddingVertical:mainSidePadding,alignItems:'stretch'},
  mainNoPadding:{flex:1,backgroundColor:Colors.background,alignItems:'stretch'},
  mainWithLoader:{flex:1,backgroundColor:Colors.background,alignItems:'stretch',justifyContent:'center'},
  // splash
  ...
  // header
  header:{backgroundColor:Colors.theme,shadowColor:'black',shadowOpacity:1,elevation:4},
  ...
  headerTitle:{color:Colors.headerTint,fontSize:18},
  // drawer header
  ...
  popupContent:{height:300,width:300,backgroundColor:Colors.background,alignItems:'stretch'},
  // list
  ...
  listLeft:{alignItems:'center',justifyContent:'center'},
  listCenter:{justifyContent:'center',paddingHorizontal:10,flex:4},
  listRight:{flex:1},
  // grid
  ...
  // menu (drawer)
  menuItemP:{paddingLeft:0,height:45,marginTop:0,marginBottom:10,width:'100%'},
  menuItem:{margin:15,alignSelf:'stretch',flexDirection:'row',alignItems:'stretch'},
  ...
  field:{textAlign:'center',marginHorizontal:8,color:Colors.textDark,fontSize:fieldFontSize},
  ...
  // shadow
  shadow:{shadowOffset:{width:5,height:5},shadowColor:'black',shadowOpacity:1,elevation:2,zIndex:999},
  // floating button
